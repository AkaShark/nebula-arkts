  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.I32) {
        this.tag_id = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 2:
      if (ftype == Thrift.Type.I32) {
        this.edge_type = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
...
Geography = function(args) {
  ...
  if (args) {
    if (args.ptVal !== undefined && args.ptVal !== null) {
      this.ptVal = new Point(args.ptVal);
    }
    if (args.lsVal !== undefined && args.lsVal !== null) {
      this.lsVal = new LineString(args.lsVal);
    }
...
Edge = function(args) {
  ...
  if (args) {
    if (args.src !== undefined && args.src !== null) {
      this.src = new Value(args.src);
    }
    if (args.dst !== undefined && args.dst !== null) {
      this.dst = new Value(args.dst);
    }
...
Duration.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      case 2:
      if (ftype == Thrift.Type.I32) {
        this.microseconds = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 3:
      if (ftype == Thrift.Type.I32) {
        this.months = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
...
DirInfo.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      case 1:
      if (ftype == Thrift.Type.STRING) {
        this.root = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
CheckpointInfo = function(args) {
  ...
  if (args) {
    ...
    if (args.parts !== undefined && args.parts !== null) {
      this.parts = Thrift.copyMap(args.parts, [LogInfo]);
    }
...
CheckpointInfo.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      case 1:
      if (ftype == Thrift.Type.I32) {
        this.space_id = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
...
LogEntry.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      case 1:
      if (ftype == Thrift.Type.I64) {
        this.cluster = input.readI64().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 2:
      if (ftype == Thrift.Type.STRING) {
        this.log_str = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
