    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i2 = 0; _i2 < _size0; ++_i2) {
          ...
          var key3 = null;
          var val4 = null;
          key3 = input.readBinary().value;
          val4 = input.readBinary().value;
...
PlanNodeDescription = function(args) {
  ...
  if (args) {
    ...
    if (args.description !== undefined && args.description !== null) {
      this.description = Thrift.copyList(args.description, [Pair]);
    }
    if (args.profiles !== undefined && args.profiles !== null) {
      this.profiles = Thrift.copyList(args.profiles, [ProfilingStats]);
    }
    if (args.branch_info !== undefined && args.branch_info !== null) {
      this.branch_info = new PlanNodeBranchInfo(args.branch_info);
    }
...
PlanNodeDescription.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      case 1:
      if (ftype == Thrift.Type.STRING) {
        this.name = input.readBinary().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 3:
      if (ftype == Thrift.Type.STRING) {
        this.output_var = input.readBinary().value;
      } else {
        input.skip(ftype);
      }
      break;
...
PlanDescription = function(args) {
  ...
  if (args) {
    if (args.plan_node_descs !== undefined && args.plan_node_descs !== null) {
      this.plan_node_descs = Thrift.copyList(args.plan_node_descs, [PlanNodeDescription]);
    } else {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i24 = 0; _i24 < _size22; ++_i24) {
          var elem25 = null;
          elem25 = new PlanNodeDescription();
          elem25.read(input);
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i28 = 0; _i28 < _size26; ++_i28) {
          ...
          var key29 = null;
          var val30 = null;
          key29 = input.readI64().value;
          val30 = input.readI64().value;
      ...
      case 3:
      if (ftype == Thrift.Type.STRING) {
        this.format = input.readBinary().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      if (ftype == Thrift.Type.I32) {
        this.optimize_time_in_us = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
...
ExecutionResponse = function(args) {
  ...
  if (args) {
    ...
    if (args.data !== undefined && args.data !== null) {
      this.data = new DataSet(args.data);
    }
    ...
    if (args.plan_desc !== undefined && args.plan_desc !== null) {
      this.plan_desc = new PlanDescription(args.plan_desc);
    }
...
ExecutionResponse.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      case 2:
      if (ftype == Thrift.Type.I64) {
        this.latency_in_us = input.readI64().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 4:
      if (ftype == Thrift.Type.STRING) {
        this.space_name = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
AuthResponse.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      case 3:
      if (ftype == Thrift.Type.I64) {
        this.session_id = input.readI64().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 4:
      if (ftype == Thrift.Type.I32) {
        this.time_zone_offset_seconds = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 5:
      if (ftype == Thrift.Type.STRING) {
        this.time_zone_name = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
